...
TANHA Ablation: No Semantic Matching

Removes the semantic matching stage from TANHA.

Entity matching relies only on exact canonical matches
...
def hybrid_match_v3(
    ...
    for i, (p_text, p_type) in enumerate(pred_entities):
        ...
        # Semantic recovery stage removed for ablation study.
